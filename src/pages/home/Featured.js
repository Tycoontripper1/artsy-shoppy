...
export const Featured = () => {
  const  FeaturedData =[
        {id: 1,
        img:'img/featured/Featured-product-3.png'},
        {id: 2,
            img:'img/featured/Featured-product-2.png'},
        {id: 3,
            img:'img/featured/Featured-product-1.png'}
       ]
    
  return (
    <main>
        {
            FeaturedData.map((loops)=>{
                return(
                    <div key={loops.id} className='relative flex flex-col lg:flex-row border-t-grey border-t-[0.5px] py-8 md:py-[60px] lg:even:flex-row-reverse first:border-t-0 lg:first:border-t last:border-b border-b-grey border-b-[0.5px]  lg:border-b-0'>
                    ...
                    <button className="flex items-end lg:items-center text-white mb-6 ml-auto mr-10 md:m-0">
                        ...
                        <img src={loops.img} alt="featuredImage" className='w-full' />
                    </div>
                    <article className='lg:w-1/2 flex flex-col justify-between text-grey lg:mr-[50px]'>
                        <h4 className='text-[30px] md:text-[2.5rem] font-semibold w-full text-center lg:text-left lg:font-bold font-clash lg:font-stix absolute text-white lg:text-grey top-12 lg:text- md:top-20 lg:relative lg:top-0'>The Boolean Egyptian</h4>
