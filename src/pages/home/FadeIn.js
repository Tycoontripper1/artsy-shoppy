...
export const FadeIn = () => {
  ...
  return (
    ...
    <img src={image3} ref={imageRef3} alt="" className=' absolute bottom-0 transition-all duration-1000 opacity-0'/>
    <img src={image2} ref={imageRef2} alt="" className=' absolute bottom-0 transition-all duration-1000 opacity-0'/>
    <img src={image1} ref={imageRef1} alt="" className=' absolute bottom-0 transition-all duration-1000 '/>
</div>
  )
}
